...
이 저장소에는 여러 프로젝트가 하위 폴더로 구성됩니다.

## 프로젝트 목록
- [`tarkov-price-overlay/`](tarkov-price-overlay/) — EFT 시세 투명 오버레이 (Tauri + React + Python)
- [`Alpha-ant's-portfolio/`](Alpha-ant's-portfolio/) — 알파 개미의 포트폴리오: 한·미 주식 포트폴리오 공유 사이트 (Next.js 14 + Supabase). 운영: `alpha-ants.aquapado.com`
...
- [`web-tools/`](web-tools/) — 뚝딱툴즈: 한국어 클라이언트사이드 웹 도구 모음 — 파일 처리 전부 브라우저(WASM), AdSense 수익화 (Next.js 14 SSG, 도구 16종·Vercel 배포, 운영 예정: `tools.aquapado.com` — `web-tools/PLAN.md` 참조)
